...
const BlacklistScreen = ({sendMessage, raidList}) => {
    function unblacklistTarget(_e){
        ...
        <div>
            <Accordion defaultExpanded>
                <AccordionSummary
                    ...
                    id="panel1-header"
                >
                    <Typography>Current Blacklist</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    {raidList !== null ? raidList.map((raidTarget) => {
                        return (
                            raidTarget["isBlacklisted"] == true // Only show the target if they're not blacklisted, not vetoed, and online.
                            ?
